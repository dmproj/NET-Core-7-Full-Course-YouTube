...
namespace hikitocAPI.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        [Route("/gaming-gpu")] //redirect to /gaming-gpu/sale
        public IActionResult Gpus()
        {
            //return new RedirectToActionResult("Sale", "Redirect", routeValues: new { model = 4090  }, permanent: true);
            //return RedirectToAction("Sale", "Redirect", routeValues: new { model = 4090  }, permanent: true);
            //return RedirectToActionPermanent("Sale", "Redirect", routeValues: new { model = 4090  });

            //return new LocalRedirectResult("gaming-gpu/sale", true);
            //return LocalRedirect("gaming-gpu/sale");
            //return LocalRedirectPermanent("gaming-gpu/sale");
            
            //return new RedirectResult("gaming-gpu/sale");
            //return Redirect("gaming-gpu/sale");
            return RedirectPermanent("gaming-gpu/sale");
