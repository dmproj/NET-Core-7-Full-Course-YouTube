...
namespace hikitocAPI.Controllers
{
    ...
    public class SolarSystemsController : ControllerBase
    {
        ...
        public IActionResult Explicit([FromQuery] int? vs, [FromHeader(Name = "Content-Type")] string? auth, [FromBody] MyPoco? myPoco)
        {
            if (vs <= 5)// vs=12345&auth=auth_strung
            {
        ...
        //[HttpPost("explicit/{vs?}/{auth?}")]
        //public async Task<IActionResult> Explicit()
        //{
